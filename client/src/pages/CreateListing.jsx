...
export default function CreateListing() {
  ...
  {
    if(files.length>0 && formData.imageUrls.length<7)
...
<span className='font-normal text-gray-600 ml-2'>
  The first imaage will be cover (max 6)</span></p>
<div className='flex gap-4'>
  <input onChange={(e)=>setFiles(e.target.files)} className='p-3 border-gray-300 rounded-w-full' type="file" if='images' accept='image/*' multiple />
